...
plt.annotate(r'' + '(%.2f' % values_proba_logi_1[0] + ', %.2f'
             ...
             color =color_text, xytext=(-150, +150), textcoords='offset points',
             fontsize=12,
...
plt.annotate(r'' + '(%.2f' % values_proba_logi_2[0] + ', %.2f'
             ...
             color =color_text, xytext=(-50, -150), textcoords='offset points',
             fontsize=12,
             arrowprops=dict(arrowstyle="->", connectionstyle="arc3,rad=-.2",
                             color=color_text))
...
plt.annotate(r'' + '(%.2f' % values_proba_logi_3[0] + ', %.2f'
             ...
             color =color_text, xytext=(100, 150), textcoords='offset points',
             fontsize=12,
             arrowprops=dict(arrowstyle="->", connectionstyle="arc3,rad=-.2",
                             color=color_text))
